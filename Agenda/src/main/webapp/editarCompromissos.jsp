		    ...
		    <div class="container mt-5">
		        <div class="row">	            
		            <div class="col-md-6">
		                <h4>Data</h4>
		                <div class="input-group date" id="datepicker" data-target-input="nearest">
		                    <input type="text" class="form-control datetimepicker-input" data-target="#datepicker" placeholder="Selecione a data" name="data" id="data" onkeypress="return isNumberKey(event)" value=<%out.print(compromisso.getData());%>>
		            ...
		            <div class="col-md-6">
		                ...
		                <div class="input-group date" id="timepicker" data-target-input="nearest">
		                    <input type="text" class="form-control datetimepicker-input" data-target="#timepicker" placeholder="Selecione a hora" name="hora" id="hora" onkeypress="return isNumberKey(event)" value=<%out.print(compromisso.getHora());%>>
